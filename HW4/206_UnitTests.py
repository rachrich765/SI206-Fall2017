...
#test that a jack is a jack and not an 11
def additional_test_1(self):
	c = Card(rank=11)
	self.assertEqual(c.rank,"Jack")
 ## Test that if you invoke the __str__ method of a card instance that
## is created with suit=0, rank=11, it returns the string "Jack of Diamonds"
def additional_test_2(self):
